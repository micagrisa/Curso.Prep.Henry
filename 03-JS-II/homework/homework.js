...
function operadoresLogicos(num1, num2, num3) {
  ...
  else if (num1>num2&&num3 && num1>0) {return "Número 1 es mayor y positivo"}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  var TablaDelSeisAlSesenta = []
for (var i=0 ; i<11 ; i++)
{TablaDelSeisAlSesenta.push (i*6)}
 return TablaDelSeisAlSesenta;
}
...
function tieneTresDigitos(numero){
  ...
  else if (numero >=1000) {return false}
  else {return true}; 
}
